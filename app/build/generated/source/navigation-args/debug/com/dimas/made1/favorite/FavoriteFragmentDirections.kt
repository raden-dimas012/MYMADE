...
public class FavoriteFragmentDirections private constructor() {
  private data class ActionFavoriteMovieTvFragmentToNavDetail(
    public val content: String,
    public val detailData: DataDomain
  ) : NavDirections {
    public override fun getActionId(): Int = R.id.action_favoriteMovieTvFragment_to_nav_detail
  ...
  public companion object {
    public fun actionFavoriteMovieTvFragmentToNavDetail(content: String, detailData: DataDomain):
        NavDirections = ActionFavoriteMovieTvFragmentToNavDetail(content, detailData)
  }
}
